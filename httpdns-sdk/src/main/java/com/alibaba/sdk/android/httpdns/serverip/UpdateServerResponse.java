...
public class UpdateServerResponse {
	...
	public UpdateServerResponse(String[] serverIps, String[] serverIpv6s, int[] serverPorts,
								int[] serverIpv6Ports) {
	...
	public UpdateServerResponse(boolean enable, String[] serverIps, String[] serverIpv6s,
