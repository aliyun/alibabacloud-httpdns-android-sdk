...
public class UpdateServerTask {
	...
	public static void updateServer(HttpDnsConfig config, String region,
									RequestCallback<UpdateServerResponse> callback) {
		...
		HttpRequest<UpdateServerResponse> httpRequest = new HttpRequest<>(requestConfig,
			new ResponseTranslator<UpdateServerResponse>() {
				@Override
	...
	private static Server[] getAllServers(String[] currentServerIps, int[] ports,
