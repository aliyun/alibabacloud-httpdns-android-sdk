...
public class RegionServerIpData {
	...
	public RegionServerIpData(String region, long requestTime, String[] serverIps, int[] ports,
	...
	public RegionServerIpData(String region, String[] serverIps, int[] ports, String[] serverV6Ips,
							  int[] v6Ports) {
