...
public class ShiftServerWatcherTest {
    ...
    private RegionServerScheduleService scheduleService = Mockito.mock(RegionServerScheduleService.class);
    ...
    public void whenAllServerUsedUpdateServerIps() {
        ...
        watcher.onFail(requestConfig, new SocketTimeoutException());
        Mockito.verify(scheduleService).updateRegionServerIps();
    }
