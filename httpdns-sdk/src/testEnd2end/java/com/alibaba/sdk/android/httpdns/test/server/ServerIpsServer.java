...
public class ServerIpsServer extends BaseDataServer<String, UpdateServerResponse> {
    ...
    public String convert(UpdateServerResponse updateServerResponse) {
        return toResponseBodyStr(updateServerResponse);
    }
     ...
     * @return
     */
    private static StringBuilder constructUpdateServerResultBody(boolean enable, String[] serverIps, String[] serverIpv6s, int[] ports, int[] v6ports) {
     ...
     * @return
     */
    private static String toResponseBodyStr(UpdateServerResponse updateServerResponse) {
